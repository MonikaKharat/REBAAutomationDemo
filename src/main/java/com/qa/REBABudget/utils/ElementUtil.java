package com.qa.REBABudget.utils;
...
public class ElementUtil {
	...
	public void selectNewlyAddedUserGroupWithPrint(By locator, String value) {
		List<WebElement> optionsList = getElements(locator);
		System.out.println(optionsList.size());
		for (WebElement e : optionsList) {
			String text = e.getText();
			System.out.println("User Groups present : " + text);
			if (text.equals(value)) {
				//e.click();
				System.out.println("Deleted User Group : " + text);
				break;
...
//	public void deleteRecentAddedUserGroupWithPrint(By locator) {
//		
//		String recentAddedUserGroup = getElement(locator).getText();
//		
//		List<WebElement> optionsList = getElements(locator1);
//		System.out.println(optionsList.size());
//		for (WebElement e : optionsList) {
//			String text = e.getText();
//			System.out.println("User Groups present : " + text);
//			if (text.equals(getElement(locator2).getText())) {
//				//e.click();
//				System.out.println("Newly added User Group is : " + text);
//				break;
//				
//			}
//			
...
//	}
	...
	//Use this utility to get the drop down list stored separately 
	public void selectDropDownValueWithPrint(By locator, String value) {
		List<WebElement> optionsList = getElements(locator);
		System.out.println("Size of User Groups dropdown list is " + optionsList.size());
		for (WebElement e : optionsList) {
			String text = e.getText();
			System.out.println("New User Group added having role : " + text);
			if (text.equals(value)) {
				e.click();
				break;
			}
	...
	public void selectDropDownValueRolePermissionWithPrint(By locator, String value) {
		List<WebElement> optionsList = getElements(locator);
		System.out.println("Size of Role Dropdown is :" + optionsList.size());
		for (WebElement e : optionsList) {
			String text = e.getText();
			System.out.println("New Role dropdown: " + text);
			if (text.equals(value)) {
				e.click();
				break;
			}
